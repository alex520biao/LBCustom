...
@implementation FVSeq2View
@synthesize seqImageView=_seqImageView;
@synthesize seqScrollView=_seqScrollView;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    */ 
        ...
        FVSeqScrollView *seqZoomView=[[FVSeqScrollView alloc] initWithFrame:CGRectMake(0, 0, 1024, 748)];
        [self addSubview:seqZoomView];
        _seqScrollView=seqZoomView;
        self.seqImageView=seqZoomView.imageSequence;
...
-(void)update_itemObj_view{
    ...
    [_seqScrollView setItemObj:_itemObj];
