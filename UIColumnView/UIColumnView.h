...
@interface UIColumnView : UIScrollView <UIScrollViewDelegate> {
    ...
    id<UIColumnViewDelegate,UIScrollViewDelegate>    viewDelegate;//alex
    ...
    //alex new
    NSUInteger					selectedIndex; //当前选中行
}
 ...
 */
@property (nonatomic, assign) id<UIColumnViewDelegate,UIScrollViewDelegate> viewDelegate;//alex
